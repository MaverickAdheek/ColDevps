...
{
    public class EditarAdministradorSistemaModel : PageModel
    {
        ...
        // Constructor
        public EditarAdministradorSistemaModel(IRepositorioAdministradorSistema repositorioAdministradorSistema)
        {
        ...
        {
            try {
                repositorioAdministradorSistema.UpdateAdministradorSistema(administradorSistema);

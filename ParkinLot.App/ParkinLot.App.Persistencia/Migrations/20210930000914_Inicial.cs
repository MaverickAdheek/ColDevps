        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EspacioParquederoId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Reservas", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Reservas_EspaciosParqueadero_EspacioParquederoId",
                        column: x => x.EspacioParquederoId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reservas_EspacioParquederoId",
                table: "Reservas",
                column: "EspacioParquederoId");
